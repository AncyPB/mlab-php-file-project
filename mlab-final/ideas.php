...
<body
 style="background-color:#30336b">
 	...
 	<form class="myform" action="ideas.php" method="post">
 		<label><b>
 			Query code:</b>
 		</label><br>
 	...
 	<?php
 		if(isset($_POST['submit'])){
 			...
 			$n1="";
 			if($query_code=='None'||$query_code=='none'||$query_code=='NONE')
 			{
 				$n="1";
 			}
 			if($n=="1"){
 			...
 			if($n1==""){
 					...
 					echo '<script type="text/javascript"> alert("Your idea has been posted. Be patient while the deals are on the way:)") </script>';
 			}
 			else{
 				...
 				echo '<script type="text/javascript"> alert("Enter valid query code") </script>';
 			}
 			}
