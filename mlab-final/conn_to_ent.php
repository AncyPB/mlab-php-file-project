...
<body
 style="background-color:#34495e">
 	<div id="main-wrapper1">
 		<center>
 			<h2>Enter the idea code of entrepreneur to get the contact details and the idea presented with detailed description</h2>
 		</center>

 	<form class="myform" action="conn_to_ent.php" method="post">
 		<label><b>
 			Idea Code:</b>
 		</label><br>
