...
<body 
  ...
  <div class="header">
    <h1 style="font-size:25;"> <i><b>View all the queries of the clients <b></i></h1> 
    <h2 style="font-size:25;"><i>Remember the query code to see the solutions by entrepreneurs</i></h2>
      <div class="header-right">
        <a class="active" href="homepginvestor.php">Back</a>
        <a class="active" href="view-solutions.php">View Solutions</a>
      </div>
    </div>
    <center>
